...
export default function Testimonials(){
  ...
  <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between">
    <div className="lg:col-span-5 lg:col-start-1">
      ...
      <div className="mb-8">
        <h2 className="mb-2 text-3xl text-gray-800 font-bold lg:text-4xl dark:text-white">
      ...
      <blockquote className="relative">
        ...
        <footer className="mt-6">
          <div className="flex items-center gap-x-4">
            ...
            <div className="grow">
              <div className="font-semibold text-gray-800 dark:text-white">Josh Grazioso</div>
              <div className="text-xs text-gray-500 dark:text-neutral-500">Director Payments & Risk | ISPA</div>
            </div>
          </div>
        </footer>
      </blockquote>
    ...
    <div className="mt-10 lg:mt-0 lg:col-span-6 lg:col-end-13">
      ...
      <ul className="grid grid-cols-2 divide-y divide-x-2 divide-gray-200 overflow-hidden dark:divide-neutral-700">
          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            <div className="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-gray-800 mb-2 dark:text-white">
              45k+
            </div>
          ...
          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            <div className="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-gray-800 mb-2 dark:text-white">
              <svg className="shrink-0 size-5 text-yellow-600 dark:text-yellow-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m5 12 7-7 7 7"/><path d="M12 19V5"/></svg>
              23%
            </div>
            <p className="text-sm sm:text-base text-gray-600 dark:text-white">
          ...
          <li className="flex flex-col -m-0.5 p-4 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-white">
              faster than previous GeniusTech versions
            </p>
          </li>
        </ul>
